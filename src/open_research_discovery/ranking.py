...
RESULT_ONLY_DEFINITION = (
    ...
    "result-and-derivation. A source-requested executable artifact may itself be the "
    "final result. Do not add a certificate, formalization, or file format absent "
    "from the source merely to change the label."
)
